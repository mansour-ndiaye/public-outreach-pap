...
export function SupervisorShell({ children, user, locale }: SupervisorShellProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#0f1035]">
      ...
      <header className={cn(
        ...
        {/* Left: Logo + role */}
        <Link href={`/${locale}/supervisor/dashboard`} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
        ...
        <div className="flex items-center gap-2">
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 dark:bg-white/[0.06]">
            <div className="w-6 h-6 rounded-full bg-brand-teal flex items-center justify-center text-white font-display font-bold text-[10px] select-none">
